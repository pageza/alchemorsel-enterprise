...
resource "aws_route_table" "private" {
  ...
  tags = merge(var.tags, {
    Name = var.enable_nat_gateway ? "${var.name_prefix}-private-rt-${var.azs[count.index]}" : "${var.name_prefix}-private-rt"
  })
}
...
# VPC Endpoints for improved security and cost
